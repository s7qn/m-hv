...
export const QuizzesView: React.FC<QuizzesViewProps> = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-blue-950 text-white rounded-2xl p-4 sm:p-8 shadow-lg shadow-blue-950/20 relative overflow-hidden">
        <div className="max-w-2xl space-y-2 sm:space-y-3 relative z-10">
          <div className="inline-flex items-center gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-blue-500/20 text-blue-200 border border-blue-400/30 text-[11px] sm:text-xs font-bold">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-4 pt-1 sm:pt-2 text-[11px] sm:text-xs font-semibold text-blue-200">
