...
export const Footer: React.FC<FooterProps> = ({ language }) => {
  ...
  return (
    <footer className="mt-16 bg-white dark:bg-[#0b1329] border-t border-blue-100 dark:border-slate-800 text-slate-700 dark:text-slate-300 transition-colors duration-200 pb-24 md:pb-6">
      {/* Upper Footer Card */}
